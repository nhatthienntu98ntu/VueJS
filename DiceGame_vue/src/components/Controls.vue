<template>
  <div>
    ...
    <button @click="randomDice" class="control btn-roll">
      <i class="ion-ios-loop"></i>Roll dice
    </button>
    <button @click="saveScoreDice" class="control btn-hold">
...
export default {
  ...
  methods: {
    newGame() {
      this.$emit("newGameApp");
    },
    randomDice() {
      this.$emit("randomDice");
    },
    saveScoreDice() {
      this.$emit("saveScoreDice");
    },
    changeFinalScore(e) {
